...
const versions = {
  primary: {
    default: "text-amber-100 bg-amber-600 opacity-90 hover:shadow-md",
    disabled: "bg-gray-50 text-gray-400 cursor-not-allowed border border-gray-200",
  },
  secondary: {
    default: "bg-white text-amber-200 border-[1px] border-amber-200 hover:shadow-sm",
    disabled: "bg-gray-50 text-gray-300 cursor-not-allowed border-400",
  },
  black: {
    default: "bg-white text-gray-700 border-gray-500 hover:border-gray-700 border-[1px] hover:border-amber-200 hover:shadow-sm hover:text-amber-200",
    ...
    <>
      <button
        ...
        className={classNames(
          "group inline-flex items-center justify-center transition-all duration-200 rounded-md border px-4 py-2 text-regular font-medium focus:ring-2 focus:border-amber-200",
