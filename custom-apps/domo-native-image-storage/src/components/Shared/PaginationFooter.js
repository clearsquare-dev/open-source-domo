            ...
            <div className="flex items-center justify-center space-x-1 sm:w-auto sm:justify-end">
              <div
                className={classNames(
                  "flex h-8 w-8 cursor-pointer items-center justify-center rounded text-sm shadow",
                  tabCount === 1 ? "cursor-not-allowed opacity-40" : offset === 0 ? "bg-indigo-400 text-white hover:bg-indigo-400 hover:text-white" : "bg-white hover:bg-gray-50"
                )}
              ...
              {tabCount > 1 && (
                <>
                  ...
                  {0 !== offset && offset + 1 !== tabCount ? <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded text-sm shadow bg-indigo-400 text-white hover:bg-indigo-400 hover:text-white">{offset + 1}</div> : null}
                  {offset < tabCount - 2 ? (
                    <div
                      className="flex h-8 w-8 cursor-pointer items-center justify-center rounded bg-white text-sm shadow hover:bg-gray-50"
                      onClick={() => onChange({ limit, offset: offset + 1 })}>
              ...
              {tabCount > 1 && (
                <div
                  className={`flex h-8 w-8 cursor-pointer items-center justify-center rounded  text-sm shadow ${offset + 1 === tabCount ? "bg-indigo-400 text-white hover:bg-indigo-400 hover:text-white" : "bg-white hover:bg-gray-50"}`}
